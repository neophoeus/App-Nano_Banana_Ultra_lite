export const fr = {
    ...
    lockSettings: 'Verrouiller les paramètres',
    unlockSettings: 'Déverrouiller les paramètres',
    settingsLocked: 'Paramètres verrouillés',
    settingsLockedNotice: 'Les paramètres sont verrouillés. Veuillez les déverrouiller d’abord.',
    lock: 'Verrouiller',
    locked: 'Verrouillé',
    ...
    footerPowered: 'Propulsé par Gemini AI',
    statusPanelLocalApi: 'Serveur',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: 'Ouvrir le terminal de debug',
    debugTerminalClose: 'Fermer',
    ...
    debugTerminalExport: 'Exporter JSON',
    debugTerminalCopySelected: 'Copier la selection',
    debugTerminalAutoScrollOn: 'Defilement auto actif',
    debugTerminalAutoScrollOff: 'Defilement auto inactif',
    debugTerminalEmpty:
        'Aucun evenement de debug pour linstant. Lancez une generation ou un outil de prompt pour commencer a capturer des traces sanitisees de requetes et de reponses.',
    debugTerminalSelectEvent: 'Selectionnez un evenement pour inspecter sa charge utile sanitisee.',
    debugTerminalFilterAll: 'Tous',
    debugTerminalFilterRequest: 'Requete',
    debugTerminalFilterResponse: 'Reponse',
    debugTerminalFilterError: 'Erreur',
    debugTerminalFilterStream: 'Flux',
    debugTerminalFilterRetry: 'Reessai',
    debugTerminalFilterLog: 'Journal',
    ...
    errorApiKey: 'L’API Gemini est indisponible dans cette session AI Studio. Reconnectez-vous.',
    ...
    composerAdvancedSafetyTitle: 'Filtres de securite',
    composerAdvancedSafetyNote:
        'Le modele par defaut omet cette categorie de Gemini safetySettings. Le reglage actuel du produit garde les quatre filtres sur Sans blocage.',
    composerAdvancedSafetyAllLabel: 'Toutes categories',
    composerAdvancedSafetyMixed: 'Mixte',
    composerAdvancedSafetyThresholdDefault: 'Modele',
    composerAdvancedSafetyThresholdOff: 'Desactive',
    composerAdvancedSafetyThresholdBlockNone: 'Sans blocage',
    composerAdvancedSafetyThresholdBlockOnlyHigh: 'Haut seul',
    composerAdvancedSafetyThresholdBlockMediumAndAbove: 'Moyen+',
    composerAdvancedSafetyThresholdBlockLowAndAbove: 'Faible+',
    ...
    stageActionDownload: 'Telecharger',
    ...
    stageDownloadCompleteNotice: 'L image de scene et les metadonnees ont ete telechargees.',
    stageDownloadFailedNotice: 'Echec du telechargement de l image de scene.',
    thoughtImageDownload: 'Telecharger l image',
    thoughtImageDownloadCompleteNotice: 'L image de reflexion a ete telechargee.',
    thoughtImageDownloadFailedNotice: 'Echec du telechargement de l image de reflexion.',
