export const ru = {
    ...
    styleLocked: 'Заблокирован стиль',
    lockSettings: 'Заблокировать настройки',
    unlockSettings: 'Разблокировать настройки',
    settingsLocked: 'Настройки заблокированы',
    settingsLockedNotice: 'Настройки заблокированы. Пожалуйста, сначала разблокируйте их.',
    lock: 'Заблокировать',
    ...
    footerPowered: 'Работает на Gemini AI',
    statusPanelLocalApi: 'Сервер',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: 'Открыть терминал отладки',
    debugTerminalClose: 'Закрыть',
    ...
    debugTerminalExport: 'Экспорт JSON',
    debugTerminalCopySelected: 'Копировать выбранное',
    debugTerminalAutoScrollOn: 'Автопрокрутка включена',
    debugTerminalAutoScrollOff: 'Автопрокрутка выключена',
    debugTerminalEmpty:
        'Событий отладки пока нет. Запустите генерацию или инструмент prompt, чтобы здесь начали накапливаться очищенные трассы запросов и ответов.',
    debugTerminalSelectEvent: 'Выберите событие, чтобы посмотреть его очищенный payload.',
    debugTerminalFilterAll: 'Все',
    debugTerminalFilterRequest: 'Запрос',
    debugTerminalFilterResponse: 'Ответ',
    debugTerminalFilterError: 'Ошибка',
    debugTerminalFilterStream: 'Поток',
    debugTerminalFilterRetry: 'Повтор',
    debugTerminalFilterLog: 'Лог',
    ...
    errorApiKey: 'Gemini API недоступен в этой сессии AI Studio. Переподключитесь.',
    ...
    clearHistoryMsg:
        'Очистить это рабочее пространство до исходного пустого состояния? История, сцена, промпт и контекст сессии будут удалены. Сначала рекомендуем использовать Экспортировать рабочее пространство. Это необратимо.',
    ...
    windowCloseWarningTitle: 'Рабочее пространство будет потеряно',
    windowCloseWarningMsg:
        'Закрытие приложения удалит текущее рабочее пространство. Отмените закрытие и сначала вернитесь, чтобы экспортировать рабочее пространство.',
    ...
    stageDownloadCompleteNotice: 'Изображение сцены и метаданные загружены.',
    stageDownloadFailedNotice: 'Не удалось загрузить изображение сцены.',
    thoughtImageDownload: 'Скачать изображение',
    thoughtImageDownloadCompleteNotice: 'Изображение из мыслительного процесса загружено.',
    thoughtImageDownloadFailedNotice: 'Не удалось загрузить изображение из мыслительного процесса.',
