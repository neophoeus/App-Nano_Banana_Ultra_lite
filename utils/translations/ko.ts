export const ko = {
    ...
    settingsLocked: '설정 잠김',
    settingsLockedNotice: '설정이 잠겨 있습니다. 먼저 잠금을 해제해 주세요.',
    lock: '잠금',
    locked: '잠김',
    ...
    footerPowered: 'Gemini AI 기반',
    statusPanelLocalApi: '서버',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: '디버그 터미널 열기',
    debugTerminalClose: '닫기',
    ...
    debugTerminalExport: 'JSON 내보내기',
    debugTerminalCopySelected: '선택 항목 복사',
    debugTerminalAutoScrollOn: '자동 스크롤 켜짐',
    debugTerminalAutoScrollOff: '자동 스크롤 꺼짐',
    debugTerminalEmpty:
        '아직 디버그 이벤트가 없습니다. 생성이나 프롬프트 도구를 실행하면 정리된 요청과 응답 추적이 여기에 쌓입니다.',
    debugTerminalSelectEvent: '이벤트를 선택하면 정리된 payload를 확인할 수 있습니다.',
    debugTerminalFilterAll: '전체',
    debugTerminalFilterRequest: '요청',
    debugTerminalFilterResponse: '응답',
    debugTerminalFilterError: '오류',
    debugTerminalFilterStream: '스트림',
    debugTerminalFilterRetry: '재시도',
    debugTerminalFilterLog: '로그',
    statusPanelLive: '정상',
    ...
    errorApiKey: '이 AI Studio 세션에서는 Gemini API를 사용할 수 없습니다. 다시 연결해 주세요.',
    clearResults: '화면 비우기',
    actionUseRef: '참조로 사용',
    actionEdit: '편집 & 리페인트',
    autoDownload: '자동 저장',
    ...
    stageDownloadCompleteNotice: '스테이지 이미지와 메타데이터를 다운로드했습니다.',
    stageDownloadFailedNotice: '스테이지 이미지 다운로드에 실패했습니다.',
    thoughtImageDownload: '이미지 다운로드',
    thoughtImageDownloadCompleteNotice: '사고 과정 이미지를 다운로드했습니다.',
    thoughtImageDownloadFailedNotice: '사고 과정 이미지 다운로드에 실패했습니다.',
