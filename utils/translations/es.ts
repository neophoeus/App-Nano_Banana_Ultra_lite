export const es = {
    ...
    unlockSettings: 'Desbloquear configuración',
    settingsLocked: 'Configuración bloqueada',
    settingsLockedNotice: 'La configuración está bloqueada. Por favor, desbloquéala primero.',
    lock: 'Bloquear',
    locked: 'Bloqueado',
    ...
    footerPowered: 'Impulsado por Gemini AI',
    statusPanelLocalApi: 'Servidor',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: 'Abrir terminal de depuracion',
    debugTerminalClose: 'Cerrar',
    ...
    debugTerminalExport: 'Exportar JSON',
    debugTerminalCopySelected: 'Copiar seleccionado',
    debugTerminalAutoScrollOn: 'Auto-scroll activado',
    debugTerminalAutoScrollOff: 'Auto-scroll desactivado',
    debugTerminalEmpty:
        'Aun no hay eventos de depuracion. Ejecuta una generacion o una herramienta de prompt para empezar a capturar trazas saneadas de solicitudes y respuestas.',
    debugTerminalSelectEvent: 'Selecciona un evento para inspeccionar su payload saneado.',
    debugTerminalFilterAll: 'Todo',
    debugTerminalFilterRequest: 'Solicitud',
    debugTerminalFilterResponse: 'Respuesta',
    debugTerminalFilterError: 'Error',
    debugTerminalFilterStream: 'Stream',
    debugTerminalFilterRetry: 'Reintento',
    debugTerminalFilterLog: 'Log',
    ...
    statusFailed: 'Falló',
    generationFailureSummaryUnknown: 'La solicitud fallo antes de poder identificar una causa fiable.',
    generationFailureSummaryPolicy: 'El prompt fue bloqueado por la politica antes de iniciar la generacion.',
    generationFailureSummarySafety: 'La salida de imagen fue bloqueada por los filtros de seguridad.',
    generationFailureSummaryTextOnly: 'El modelo respondio solo con texto y sin imagen.',
    ...
    generationFailureDetailTextOnly: 'Se devolvio contenido de texto, pero no se emitieron bytes de imagen.',
    generationFailureDetailThoughtsOnly:
        'Solo se devolvieron los resumenes internos del modelo, pero no se emitieron bytes de imagen.',
    generationFailureDetailMissingCandidates: 'El modelo no devolvio candidatos de salida.',
    ...
    generationFailureDetailPossibleBatchSafetySuppression:
        'Otro resultado de este lote fue bloqueado de forma explicita por los filtros de seguridad de imagen. Este intento tambien podria haber sido suprimido por la misma razon, pero la respuesta no aporta senales suficientes para confirmarlo.',
    generationFailureDetailFinishReason: 'Motivo de finalizacion del modelo: {0}.',
    generationFailureValuePromptBlockReasonBlocklist: 'bloqueado por reglas de terminos restringidos',
    generationFailureValuePromptBlockReasonProhibitedContent: 'bloqueado por contenido prohibido',
    generationFailureValuePromptBlockReasonSafety: 'bloqueado por reglas de seguridad de la politica',
    generationFailureValuePromptBlockReasonUnspecified: 'bloqueado por reglas de la politica',
    generationFailureValuePromptBlockReasonOther: 'bloqueado por reglas de la politica',
    generationFailureValueFinishReasonStop: 'termino sin generar imagen',
    generationFailureValueFinishReasonNoImage: 'termino sin devolver una imagen',
    generationFailureValueFinishReasonUnspecified: 'termino sin una razon especifica del resultado de imagen',
    generationFailureValueFinishReasonImageSafety: 'bloqueado por filtros de seguridad de imagen',
    generationFailureValueFinishReasonImageProhibitedContent: 'bloqueado por contenido de imagen prohibido',
    generationFailureValueFinishReasonBlocklist: 'bloqueado por reglas de lista de bloqueo',
    generationFailureValueFinishReasonProhibitedContent: 'bloqueado por contenido prohibido',
    generationFailureValueFinishReasonImageOther: 'termino sin generar imagen',
    generationFailureValueFinishReasonSafety: 'bloqueado por filtros de seguridad',
    generationFailureValueFinishReasonBlocked: 'bloqueado por la politica del modelo',
    generationFailureValueFinishReasonOther: 'otro estado de finalizacion sin imagen',
    generationFailureValueSafetyCategoryHarassment: 'acoso',
    generationFailureValueSafetyCategoryHateSpeech: 'discurso de odio',
    generationFailureValueSafetyCategorySexuallyExplicit: 'contenido sexual explicito',
    generationFailureValueSafetyCategoryDangerousContent: 'contenido peligroso',
    generationFailureValueSafetyCategoryOther: 'otra politica de seguridad',
    ...
    errorApiKey: 'La API de Gemini no está disponible en esta sesión de AI Studio. Reconecta, por favor.',
    ...
    editorPromptLabel: 'Indicaciones',
    editorTextInputPlaceholder: 'Escribe el texto que quieres visible en la imagen',
    editorTextInputHintPrimary: 'El texto en el lienzo se renderiza como texto visible.',
    editorTextInputHintSecondary: 'Usa Prompt para instrucciones que no deban aparecer en la imagen.',
    editorTextToolHintTitle: 'Agregar texto visible',
    editorTextToolHintBody: 'El texto colocado en el lienzo está pensado para aparecer en la imagen final.',
    editorTextFirstUseTitle: 'El texto del lienzo es para la salida visible',
    editorTextFirstUseBody:
        'Si el texto debe aparecer en la imagen final, colócalo en el lienzo. Si solo es una instrucción, escríbela en Prompt.',
    editorTextFirstUseConfirm: 'Entendido',
    ...
    generationModeTextToImage: 'Texto a imagen',
    generationModeReferenceImage: 'Generacion desde imagen de referencia',
    generationModeEditorEdit: 'Nuevo render del editor',
    ...
    logImageToPromptOk: 'Prompt extraido de la imagen.',
    logImageToPromptFailed: 'Fallo al convertir la imagen en prompt.',
    ...
    catCraft: 'Materiales',
    catDesign: 'Design',
    catPhotoFilm: 'Foto y Cine',
    catPaintDrawing: 'Pintura y Dibujo',
    catIllustration: 'Ilustración',
    catComicsAnime: 'Cómic y Anime',
    catGraphicDesign: 'Diseño Gráfico',
    catThreeDPixel: '3D y Pixel',
    catCraftMaterial: 'Artesanía y Materiales',
    ...
    styleVintageInstantPhoto: 'Foto Instantánea Vintage',
    ...
    styleComicIllustration: 'Ilustración de Cómic',
    ...
    styleDigitalIllustration: 'Ilustración Digital',
    stylePainterlyIllustration: 'Ilustración Pictórica',
    styleEditorialIllustration: 'Ilustración Editorial',
    styleConceptArt: 'Arte Conceptual',
    ...
    stageDownloadCompleteNotice: 'Se descargaron la imagen del escenario y los metadatos.',
    stageDownloadFailedNotice: 'No se pudo descargar la imagen del escenario.',
    thoughtImageDownload: 'Descargar imagen',
    thoughtImageDownloadCompleteNotice: 'Se descargo la imagen del proceso mental.',
    thoughtImageDownloadFailedNotice: 'No se pudo descargar la imagen del proceso mental.',
    ...
    workspaceSideToolRepaintCurrentImage: 'Repintar la imagen actual',
    workspaceSideToolUploadToRepaint: 'Subir imagen para repintar',
    workspaceSideToolDrawReferenceSketch: 'Dibujar boceto de referencia',
