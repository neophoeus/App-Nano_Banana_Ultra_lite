export const ja = {
    ...
    lockSettings: '設定をロック',
    unlockSettings: '設定のロックを解除',
    settingsLocked: '設定はロックされています',
    settingsLockedNotice: '設定はロックされています。まずロックを解除してください。',
    lock: 'ロック',
    locked: 'ロック済み',
    ratioSkyscraper: '超縦長',
    ratioTall: '縦長',
    ...
    footerPowered: 'Gemini AI 搭載',
    statusPanelLocalApi: 'サーバー',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: 'デバッグターミナルを開く',
    debugTerminalClose: '閉じる',
    ...
    debugTerminalExport: 'JSON をエクスポート',
    debugTerminalCopySelected: '選択項目をコピー',
    debugTerminalAutoScrollOn: '自動スクロール オン',
    debugTerminalAutoScrollOff: '自動スクロール オフ',
    debugTerminalEmpty:
        'まだデバッグイベントはありません。生成またはプロンプトツールを実行すると、サニタイズ済みのリクエストと応答トレースがここに蓄積されます。',
    debugTerminalSelectEvent: 'イベントを選択すると、サニタイズ済み payload を確認できます。',
    debugTerminalFilterAll: 'すべて',
    debugTerminalFilterRequest: 'リクエスト',
    debugTerminalFilterResponse: 'レスポンス',
    debugTerminalFilterError: 'エラー',
    debugTerminalFilterStream: 'ストリーム',
    debugTerminalFilterRetry: '再試行',
    debugTerminalFilterLog: 'ログ',
    statusPanelLive: '稼働中',
    ...
    errorApiKey: 'この AI Studio セッションでは Gemini API を利用できません。再接続してください。',
    ...
    composerAdvancedSafetyTitle: '安全フィルター',
    composerAdvancedSafetyNote:
        'モデル既定では、そのカテゴリを Gemini safetySettings から省略します。現在の製品既定は 4 カテゴリすべてを「遮断なし」のまま維持します。',
    composerAdvancedSafetyAllLabel: '全カテゴリ',
    composerAdvancedSafetyMixed: '混在',
    composerAdvancedSafetyThresholdDefault: 'モデル既定',
    composerAdvancedSafetyThresholdOff: 'オフ',
    composerAdvancedSafetyThresholdBlockNone: '遮断なし',
    composerAdvancedSafetyThresholdBlockOnlyHigh: '高のみ',
    composerAdvancedSafetyThresholdBlockMediumAndAbove: '中以上',
    composerAdvancedSafetyThresholdBlockLowAndAbove: '低以上',
    ...
    stageDownloadCompleteNotice: 'ステージ画像とメタデータをダウンロードしました。',
    stageDownloadFailedNotice: 'ステージ画像のダウンロードに失敗しました。',
    thoughtImageDownload: '画像をダウンロード',
    thoughtImageDownloadCompleteNotice: '思考画像をダウンロードしました。',
    thoughtImageDownloadFailedNotice: '思考画像のダウンロードに失敗しました。',
