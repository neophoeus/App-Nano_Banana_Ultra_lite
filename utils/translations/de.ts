export const de = {
    ...
    settingsLockedNotice: 'Die Einstellungen sind gesperrt. Bitte entsperren Sie sie zuerst.',
    lock: 'Sperren',
    locked: 'Gesperrt',
    ...
    footerPowered: 'Angetrieben von Gemini AI',
    statusPanelLocalApi: 'Server',
    statusPanelGeminiKey: 'AI Studio',
    debugTerminalOpen: 'Debug-Terminal offnen',
    debugTerminalClose: 'Schliessen',
    ...
    debugTerminalExport: 'JSON exportieren',
    debugTerminalCopySelected: 'Auswahl kopieren',
    debugTerminalAutoScrollOn: 'Auto-Scroll aktiv',
    debugTerminalAutoScrollOff: 'Auto-Scroll aus',
    debugTerminalEmpty:
        'Noch keine Debug-Ereignisse. Fuehre eine Generierung oder ein Prompt-Werkzeug aus, um bereinigte Anfrage- und Antwortspuren zu sammeln.',
    debugTerminalSelectEvent: 'Waehle ein Ereignis aus, um seine bereinigte Payload zu pruefen.',
    debugTerminalFilterAll: 'Alle',
    debugTerminalFilterRequest: 'Anfrage',
    debugTerminalFilterResponse: 'Antwort',
    debugTerminalFilterError: 'Fehler',
    debugTerminalFilterStream: 'Stream',
    debugTerminalFilterRetry: 'Wiederholung',
    ...
    errorApiKey: 'Die Gemini-API ist in dieser AI Studio-Sitzung nicht verfügbar. Bitte neu verbinden.',
    ...
    stageActionDownload: 'Herunterladen',
    ...
    stageDownloadCompleteNotice: 'Buehnenbild und Metadaten wurden heruntergeladen.',
    stageDownloadFailedNotice: 'Buehnenbild konnte nicht heruntergeladen werden.',
    thoughtImageDownload: 'Bild herunterladen',
    thoughtImageDownloadCompleteNotice: 'Gedankenbild wurde heruntergeladen.',
    thoughtImageDownloadFailedNotice: 'Gedankenbild konnte nicht heruntergeladen werden.',
