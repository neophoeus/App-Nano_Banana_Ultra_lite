                        ...
                        >
                            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                                <div className="flex min-w-0 items-center gap-2">
                                    <BananaMark />
                                    <BrandWordmark
                                        className="max-w-[148px] text-[12px] sm:max-w-none sm:text-[13px]"
                                        mainClassName="font-black tracking-[0.08em] text-slate-900 dark:text-slate-100"
                                        liteClassName="text-[10px] sm:text-[11px]"
                                    />
                                </div>
