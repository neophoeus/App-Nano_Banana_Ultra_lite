...
Lite is intended to run inside Google AI Studio. Gemini API access comes from the AI Studio environment automatically; Lite does not support manual browser API-key entry or a separate local standalone key flow.
